...
<head>
    ...
    @else
        <style></style>
    @endif
    <title>Diyo Aviation Admin Panel</title>
</head>
    ...
    <aside class="relative bg-[#ffffff] h-screen w-[20%] hidden lg:block">
        ...
        <nav class="text-white text-xs font-semibold">
            <a href="{{ route('dashboard.index') }}"
                class="{{ request()->routeIs('dashboard.*') ? 'flex items-center py-[12px] px-5 bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl ml-8 shadow-md mt-7 mr-4 font-[markPro]' : 'flex items-center py-2 px-8 text-gray-600 mt-7 font-[markPro]' }}">
                ...
                @endif
                <span
                    class="pl-5 text-[13.5px] {{ request()->routeIs('dashboard.*') ? 'text-[#ffffff]' : 'text-[#222222B2]' }}">Dashboard</span>
            </a>

            <a href="{{ route('bookings.index') }}"
                class="{{ request()->routeIs('bookings.*') ? 'flex items-center py-[12px] px-5 bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl ml-8 shadow-md mt-7 mr-4 font-[markPro]' : 'flex items-center py-2 px-8 text-gray-600 mt-7 font-[markPro]' }}">
                ...
                @endif
                <span
                    class="pl-5 text-[13.5px] {{ request()->routeIs('bookings.*') ? 'text-[#ffffff]' : 'text-[#222222B2]' }}">Bookings</span>
            </a>

            <a href="{{ route('fleet.index') }}"
                class="{{ request()->routeIs('fleet.*') ? 'flex items-center py-[12px] px-5 bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl ml-8 shadow-md mt-7 mr-4 font-[markPro]' : 'flex items-center py-2 px-8 text-gray-600 mt-7 font-[markPro]' }}">
                @if (request()->routeIs('fleet.*'))
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                @endif
                <span
                    class="pl-5 text-[13.5px] {{ request()->routeIs('fleet.*') ? 'text-[#ffffff]' : 'text-[#222222B2]' }}">Fleets</span>
            </a>

            <a href="{{ route('blogs.index') }}"
                class="{{ request()->routeIs('blogs.*') ? 'flex items-center py-[12px] px-5 bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl ml-8 shadow-md mt-7 mr-4 font-[markPro]' : 'flex items-center py-2 px-8 text-gray-600 mt-7 font-[markPro]' }}">
                ...
                @endif
                <span
                    class="pl-5 text-[13.5px] {{ request()->routeIs('blogs.*') ? 'text-[#ffffff]' : 'text-[#222222B2]' }}">Blogs</span>
            </a>

            <a href="{{ route('contacts.index') }}"
                class="{{ request()->routeIs('contacts.*') ? 'flex items-center py-[12px] px-5 bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl ml-8 shadow-md mt-7 mr-4 font-[markPro]' : 'flex items-center py-2 px-8 text-gray-600 mt-7 font-[markPro]' }}">
                ...
                @endif
                <span
                    class="pl-5 text-[13.5px] {{ request()->routeIs('contacts.*') ? 'text-[#ffffff]' : 'text-[#222222B2]' }}">Contacts</span>
            </a>

            <a href="{{ route('newsletters.index') }}"
                class="{{ request()->routeIs('newsletters.*') ? 'flex items-center py-[12px] px-5 bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl ml-8 shadow-md mt-7 mr-4 font-[markPro]' : 'flex items-center py-2 px-8 text-gray-600 mt-7 font-[markPro]' }}">
                @if (request()->routeIs('newsletters.*'))
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M6.5 20.25C5.4 20.25 4.45833 19.8583 3.675 19.075C2.89167 18.2917 2.5 17.35 2.5 16.25V8.25C2.5 7.15 2.89167 6.20833 3.675 5.425C4.45833 4.64167 5.4 4.25 6.5 4.25H18.5C19.6 4.25 20.5417 4.64167 21.325 5.425C22.1083 6.20833 22.5 7.15 22.5 8.25V16.25C22.5 17.35 22.1083 18.2917 21.325 19.075C20.5417 19.8583 19.6 20.25 18.5 20.25H6.5ZM6.5 8.25H18.5C18.8667 8.25 19.2167 8.29167 19.55 8.375C19.8833 8.45833 20.2 8.59167 20.5 8.775V8.25C20.5 7.7 20.3043 7.22933 19.913 6.838C19.5217 6.44667 19.0507 6.25067 18.5 6.25H6.5C5.95 6.25 5.47933 6.446 5.088 6.838C4.69667 7.23 4.50067 7.70067 4.5 8.25V8.775C4.8 8.59167 5.11667 8.45833 5.45 8.375C5.78333 8.29167 6.13333 8.25 6.5 8.25ZM4.65 11.5L15.775 14.2C15.925 14.2333 16.075 14.2333 16.225 14.2C16.375 14.1667 16.5167 14.1 16.65 14L20.125 11.1C19.9417 10.85 19.7083 10.646 19.425 10.488C19.1417 10.33 18.8333 10.2507 18.5 10.25H6.5C6.06667 10.25 5.68767 10.3627 5.363 10.588C5.03833 10.8133 4.80067 11.1173 4.65 11.5Z"
                ...
                @endif
                <span
                    class="pl-5 text-[13.5px] {{ request()->routeIs('newsletters.*') ? 'text-[#ffffff]' : 'text-[#222222B2]' }}">Newsletter</span>
            </a>

            <a href="{{ route('users.index') }}"
                class="{{ request()->routeIs('users.*') ? 'flex items-center py-[12px] px-5 bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl ml-8 shadow-md mt-7 mr-4 font-[markPro]' : 'flex items-center py-2 px-8 text-gray-600 mt-7 font-[markPro]' }}">
                ...
                @endif
                <span
                    class="pl-5 text-[13.5px] {{ request()->routeIs('users.*') ? 'text-[#ffffff]' : 'text-[#222222B2]' }}">Admins</span>
            </a>

            <form method="POST" action="{{ route('logout') }}"
                class="flex items-center py-2 px-8 text-gray-600 mt-7 font-[markPro]">
                @csrf
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header class="w-full items-center bg-white py-2 px-6 hidden lg:flex justify-between">
            <div class="w-full flex flex-row justify-between">
                ...
                <div class="flex">
                    <img src="https://ui-avatars.com/api/?color=fff&background=039FC3&name={{ auth()->user()->name }}"
                        alt="User" class="w-[45px] h-[45px] rounded-full font-[migateBold]">
                    <div class="ml-2">
                        <p class="text-[12px] text-[#222222] font-[markProBold]">{{ auth()->user()->name }}</p>
                        <p class="text-[10.5px] text-[#22222280] font-[markPro]">Account</p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-[#ffffff] py-5 px-6 lg:hidden">
            ...
            <nav :class="isOpen ? 'flex' : 'hidden'" class="w-full flex flex-col pt-4">
                ...
                <a href="{{ route('dashboard.index') }}"
                    class="{{ request()->routeIs('dashboard.*') ? 'flex items-center py-2 pl-4 nav-item bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl shadow-md font-[markPro]' : 'flex items-center py-2 pl-4 nav-item text-gray-600 font-[markPro]' }}">
                    @if (request()->routeIs('dashboard.*'))
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="mr-3">
                ...
                <a href="{{ route('bookings.index') }}"
                    class="{{ request()->routeIs('bookings.*') ? 'flex items-center py-2 pl-4 nav-item bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl shadow-md font-[markPro]' : 'flex items-center py-2 pl-4 nav-item text-gray-600 font-[markPro]' }}">
                    @if (request()->routeIs('bookings.*'))
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <a href="{{ route('fleet.index') }}"
                    class="{{ request()->routeIs('fleet.*') ? 'flex items-center py-2 pl-4 nav-item bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl shadow-md font-[markPro]' : 'flex items-center py-2 pl-4 nav-item text-gray-600 font-[markPro]' }}">
                    @if (request()->routeIs('fleet.*'))
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <a href="{{ route('blogs.index') }}"
                    class="{{ request()->routeIs('blogs.*') ? 'flex items-center py-2 pl-4 nav-item bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl shadow-md font-[markPro]' : 'flex items-center py-2 pl-4 nav-item text-gray-600 font-[markPro]' }}">
                    @if (request()->routeIs('blogs.*'))
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <a href="{{ route('contacts.index') }}"
                    class="{{ request()->routeIs('contacts.*') ? 'flex items-center py-2 pl-4 nav-item bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl shadow-md font-[markPro]' : 'flex items-center py-2 pl-4 nav-item text-gray-600 font-[markPro]' }}">
                    @if (request()->routeIs('contacts.*'))
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <a href="{{ route('newsletters.index') }}"
                    class="{{ request()->routeIs('newsletters.*') ? 'flex items-center py-2 pl-4 nav-item bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl shadow-md font-[markPro]' : 'flex items-center py-2 pl-4 nav-item text-gray-600 font-[markPro]' }}">
                    @if (request()->routeIs('newsletters.*'))
                    ...
                    @endif
                    <span
                        class="pl-5 text-[13.5px] {{ request()->routeIs('newsletters.*') ? 'text-[#ffffff]' : 'text-[#222222B2]' }}">Newsletters</span>
                </a>

                <a href="{{ route('users.index') }}"
                    class="{{ request()->routeIs('users.*') ? 'flex items-center py-2 pl-4 nav-item bg-gradient-to-r from-[#039FC3] to-[#2B2B2B] text-white rounded-xl shadow-md font-[markPro]' : 'flex items-center py-2 pl-4 nav-item text-gray-600 font-[markPro]' }}">
                    @if (request()->routeIs('users.*'))
                        <svg width="25" height="25" viewBox="0 0 24.00 24.00" fill="none"
                            xmlns="http://www.w3.org/2000/svg" stroke="" stroke-width="0.00024000000000000003">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
